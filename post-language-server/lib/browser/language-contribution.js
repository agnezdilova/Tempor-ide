...
var PoSTClientContribution = /** @class */ (function (_super) {
    __extends(PoSTClientContribution, _super);
    function PoSTClientContribution(workspace, languages, languageClientFactory) {
    ...
    Object.defineProperty(PoSTClientContribution.prototype, "globPatterns", {
        get: function () {
            return [
    ...
    Object.defineProperty(PoSTClientContribution.prototype, "documentSelector", {
        get: function () {
            return [
                common_1.POST_LANGUAGE_SERVER_ID
            ];
        },
        enumerable: true,
        configurable: true
    });
    PoSTClientContribution = __decorate([
    ...
    ], PoSTClientContribution);
    return PoSTClientContribution;
}(browser_1.BaseLanguageClientContribution));
exports.PoSTClientContribution = PoSTClientContribution;
